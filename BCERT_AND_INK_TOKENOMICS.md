...
## INK: Metered Utility Consumption
...
## BCERT → INK Conversion Model

When services are used:

- BCERT is **converted into INK**
- INK is **consumed based on actual usage**
- BCERT remains reusable as long-term access capital

This creates a **streaming utility economy**:
